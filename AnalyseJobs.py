...
df = pd.read_csv('2018-02-01.csv');
df_com = pd.read_csv('Company.csv');
# print(df.head(3));

def cleanAgentCompany(df):
    _df = df;
    _removeComp = "Consult|recruit|Person|Search|Conn|Solution|Online|db |Tech|Info|Inno|Talent|Agent|Excel|Career|McKinley|Partner|Robert Walters|George Samuel|Wellesley Associates|HKT|Asian TAT Limited|Statsmaster";
